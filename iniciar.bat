...
start "Backend Extrator" cmd /k "cd backend && call venv\Scripts\activate.bat && uvicorn app.main:app --host 127.0.0.1 --port 8000 --reload"

echo [2/2] Iniciando Frontend (React/Vite)...
start "Frontend Extrator" cmd /k "cd frontend && npm run dev"
